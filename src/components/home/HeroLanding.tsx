  ...
  return (
    <section className="relative overflow-hidden bg-gray-900 min-h-[85vh] md:min-h-[92vh] lg:min-h-screen flex items-center">
      ...
      <div className="container mx-auto px-4 relative z-10 py-32 md:py-44 lg:py-56 text-center">
        <h1 className="text-white font-extralight leading-tight tracking-tight text-4xl md:text-6xl lg:text-7xl">
          Construimos hogares para tu vida
          <br className="hidden md:block"/>
          <span className="block">Calidad, diseño y respaldo Kinku</span>
        </h1>
        <p className="mt-6 text-white/70 max-w-3xl mx-auto text-xs md:text-sm">
        ...
        <div className="mt-10">
          <button className="btn border border-white/30 text-white hover:bg-white hover:text-gray-900">
            VER PROYECTOS
          </button>
        </div>
      </div>
